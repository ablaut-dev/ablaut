//! German conjugation — the original engine. Weak/strong/mixed
//! classes with a compiled-in lexicon, separable prefixes, full
//! analytic tenses and both Konjunktiv rows.
...
use self::lexicon::{DualRuling, LexClass, LexEntry};
use self::orthography::attach;
use self::prefix::Separability;
use self::suppletive::Suppletive;
