#!/usr/bin/env python3
"""Convert the FreeLing Spanish verb entries (EAGLES tags) into the
lemma<TAB>form<TAB>features TSV that the Spanish golden harness reads.

Usage: python3 scripts/spa/freeling_to_tsv.py data/spa/freeling-verbs.src \
           > data/spa/freeling.tsv
...
The feature schema matches scripts/spa/kaikki_to_tsv.py so
