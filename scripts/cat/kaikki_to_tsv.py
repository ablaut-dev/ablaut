#!/usr/bin/env python3
"""Convert the kaikki.org (Wiktextract) Catalan verb JSONL into the
lemma<TAB>form<TAB>features TSV that the Catalan golden harness reads.

Usage: python3 scripts/cat/kaikki_to_tsv.py data/cat/kaikki-verbs.jsonl \
           > data/cat/kaikki.tsv
...
The feature schema matches scripts/cat/freeling_to_tsv.py.
"""
import json
import sys
