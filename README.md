...
<p align="center">A fast, correct German verb conjugator.</p>
...
- **Measured correctness.** Every generated form is validated against two
  ...
  [adjudication log](docs/adjudications-deu.tsv) with references to standard
  grammars.
...
The exception lexicon ([`data/verbs-deu.tsv`](data/verbs-deu.tsv), about 900
...
(`scripts/fetch_unimorph_deu.sh`, `scripts/fetch_kaikki_deu.sh`) and CI fails if
...
[`docs/adjudications-deu.tsv`](docs/adjudications-deu.tsv): UniMorph gives the
